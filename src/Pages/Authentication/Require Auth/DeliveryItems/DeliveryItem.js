...
const DeliveryItem = () => {
    ...
    const {item, handleQuantity, handleDelivery } = useInventory(itemId);
    const { _id, name, description, price,supplierName, img, quantity } = item;
    ...
    return (
      ...
      className="text-left px-5">
        ...
        <p className="text-xl text-gray-700 my-2">supplier: {supplierName}</p>
