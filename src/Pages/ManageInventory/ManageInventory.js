      ...
      <div> 
         {
             ...
             <h5>Name: {product.name}</h5> <h5>Price: <span className='text-danger'>${product.price}</span></h5><h5 className='text-danger'>Quantity: {product.quantity}</h5> <h5>Supplier: {product.supplierName}</h5>
