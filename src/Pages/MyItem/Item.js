...
const Item = ({ item }) => {
  const { _id, img, name, price, description, quantity, supplier: supplierName } = item;
  ...
  return (
    ...
    >
      <div className="rounded-lg shadow-lg bg-[#2C5364] max-w-sm flex flex-col justify-end">
        <div className="px-4">
          <img className="rounded-t-lg py-2 mx-auto" src={img} alt="" />
        </div>
        <div className="p-6 text-left">
          ...
          <p className="text-xl text-gray-300">Supplier: {supplierName}</p>
